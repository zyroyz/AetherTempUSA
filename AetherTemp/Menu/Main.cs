    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            // Menu Background
                ...
                menuBackground.GetComponent<Renderer>().material.color = new Color(0.137f, 0.055f, 0.169f);
                menuBackground.transform.position = new Vector3(0.05f, 0f, 0f);
            ColorChanger colorChanger = menuBackground.AddComponent<ColorChanger>();
            colorChanger.colorInfo = BGCOLOR;
            colorChanger.Start();
            ...
            // Title and FPS
                ...
                component.sizeDelta = new Vector2(0.13f, 0.02f);
                component.position = new Vector3(0.06f, 0.055f, 0.22f);
            ...
            text1.text = "Version = " + PluginInfo.Version;
            text1.fontSize = 1;
            ...
            component1.sizeDelta = new Vector2(0.11f, 0.02f);
            component1.position = new Vector3(0.06f, 0.065f, 0.2f);
            ...
            if (fpsCounter)
                {
                    ...
                    component2.sizeDelta = new Vector2(0.08f, 0.01f);
                    component2.position = new Vector3(0.06f, -0.04f, 0.218f);
            ...
            // Buttons
                ...
                // Page Buttons
                    ...
                    gameObject.transform.localScale = new Vector3(0.09f, 0.1f, 0.9f);
                    gameObject.transform.localPosition = new Vector3(0.56f, 0.5f, 0);
                    gameObject.GetComponent<Renderer>().material.color = new Color(0.137f, 0.055f, 0.169f);
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.transform.parent = menu.transform;
            gameObject.transform.rotation = Quaternion.identity;
            gameObject.transform.localScale = new Vector3(0.035f, 0.08f, 0.08f);
            gameObject.transform.localPosition = new Vector3(0.56f, 0.32f, 0.42f - offset);
            gameObject.AddComponent<Classes.Button>().relatedText = method.buttonText;


            ColorChanger1 colorChanger = gameObject.AddComponent<ColorChanger1>();
            if (method.enabled)
            {
                colorChanger.colorInfo = buttonColors1[1];
            }
            else
            {
                colorChanger.colorInfo = buttonColors1[0];
            }
            colorChanger.Start();
            ...
            RectTransform component = text.GetComponent<RectTransform>();
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(.17f, .025f);
            component.localPosition = new Vector3(.064f, 0f, .162f - offset / 2.6f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
        }
